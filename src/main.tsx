...
if (!convexUrl) {
  ...
  window.parent?.postMessage(
    { type: "STUNNING_APP_ERROR", error: "MISSING_CONVEX_URL" },
    "*"
  );
  ...
  createRoot(document.getElementById("root")!).render(
    ...
    >
      ...
      <p>
        <strong>To fix:</strong> Ask the AI to redeploy the application.
      </p>
      <details style={{ marginTop: "1rem" }}>
        ...
        <p>
          The Convex deployment URL wasn't properly configured. This usually
          happens if:
        </p>
        <ul>
        ...
        <p>
          Solution: Tell the AI "Please redeploy" and it will fix this
          automatically.
        </p>
      </details>
    </div>
